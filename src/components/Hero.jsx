        ...
        <div className="max-w-7xl text-center lg:text-left mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center relative">
          ...
          <div>
            ...
            <div>
              ...
              <p className="text-md sm:text-base lg:text-lg text-slate-300 max-w-2xl mx-auto mg:mx-0 mb-6 sm:mb-8 animate-in slide-in-from-bottom duration-700  delay-200 leading-relaxed">
